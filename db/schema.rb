...
ActiveRecord::Schema.define(version: 20140425122343) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

# Could not dump table "attachments" because of following NoMethodError
#   undefined method `column_spec_with_oracle_enhanced' for #<ActiveRecord::ConnectionAdapters::PostgreSQLAdapter:0x007f9a771313c0>
